...
#define	AUTH		/* Define if you want simple authentication */
...
#define MINFREE 1000	/* NNTP will not allow an XFER if there is less */
...
#undef	FAKESYSLOG	"/usr/lib/news/nntp/nntplog"
#undef	FAKEAPPEND
...
#undef DO_DOTDIR	/* the mini-inews will get the .signature file from */
...
#define STAT_FILE	"/var/adm/mgdstats"
#define NGDATE_FILE	"/var/adm/groupdates"
...
#ifdef CNEWS
# define ACTIVE_TIMES_FILE	"/usr/lib/news/nntp/active.times"
#endif
