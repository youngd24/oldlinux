...
hdsetup:  ADD
idekern:  Linux kernel version .99 patch level 15, without SCSI support. 
idekern:  REC
lilo:     The Linux Loader: boots Linux from your hard drive. (v. 0.14)
lilo:     ADD
passwd:   Password utilities, and account maintenance programs.
passwd:   ADD
scsikern: Linux kernel version .99 patch level 15, with SCSI support. 
scsikern: REC
sysvinit: Version 2.4 of the System V compatible INIT programs.  
sysvinit: ADD
bin:      System utilities and programs, such as GNU fileutils 3.9,
bin:      ADD
ldso:     ld.so 1.4, the dynamic linker/loader
ldso:     ADD
...
ps:       ADD
shlibs:   The shared C libraries libc.so.4.5.19 and libm.so.4.5.19. 
shlibs:   ADD
util:     Selected utilities from the package util-linux
util:     ADD
...
shellutl: ADD
shlbsvga: Shared library libsvga.so.1.0.9 (from svgalib 1.00)
shlbsvga: ADD
