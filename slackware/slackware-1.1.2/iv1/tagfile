...
#
# This one comes from disk: IV1 (Interviews apps/libraries)
...
# 
#
ivlibs31: link libraries for programming InterViews.
ivlibs31: OPT
ivincs:   include files for programming InterViews              
ivincs:   OPT
doc31:    An X-windows based WYSIWYG editor that saves in TeX format.
doc31:    OPT
idraw:    A drawing program that saves in Postscript.
idraw:    OPT
